...
import dimensionshard.libs.ProbabilitySelector;
...
import static dimensionshard.DsItems.dimensionShardOre;
...
/**
 * Copied from SerpuloPlanetGenerator
 *
 * @author abomb4 2023-08-03
 */
public class WrekPlanetGenerator extends PlanetGenerator {
    //alternate, less direct generation (wip)
    public static boolean alt = false;

    WrekBaseGenerator basegen = new WrekBaseGenerator();
    float scl = 5f;
    ...
    Block[][] arr =
        {
            {Blocks.water, Blocks.mud, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass,
                Blocks.sand, Blocks.sand, Blocks.sand, Blocks.craters, Blocks.dacite, Blocks.dacite, Blocks.space},
            {Blocks.water, Blocks.mud, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.darksand,
                Blocks.sand, Blocks.darkPanel2, Blocks.sand, Blocks.craters, Blocks.dacite, Blocks.dacite,
                Blocks.space},
            {Blocks.water, Blocks.darkPanel3, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.dirt, Blocks.sand,
                Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.craters, Blocks.dacite, Blocks.dacite,
                Blocks.space},
            {Blocks.deepwater, Blocks.water, Blocks.darksand, Blocks.mud, Blocks.dirt, Blocks.sand, Blocks.darksand,
                Blocks.darkPanel2, Blocks.darksand, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite,
                Blocks.space},
            {Blocks.water, Blocks.water, Blocks.grass, Blocks.grass, Blocks.mud, Blocks.grass, Blocks.dirt,
                Blocks.grass, Blocks.sand, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.space},
            {Blocks.water, Blocks.water, Blocks.grass, Blocks.grass, Blocks.dirt, Blocks.grass, Blocks.grass,
                Blocks.darkPanel3, Blocks.darksand, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite,
                Blocks.space},
            {Blocks.water, Blocks.water, Blocks.sand, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.mud, Blocks.sand,
                Blocks.moss, Blocks.stone, Blocks.snow, Blocks.iceSnow, Blocks.dacite, Blocks.space},
            {Blocks.deepwater, Blocks.sandWater, Blocks.sand, Blocks.dirt, Blocks.grass, Blocks.grass,
                Blocks.darkPanel4, Blocks.basalt, Blocks.basalt, Blocks.snow, Blocks.snow, Blocks.iceSnow,
                Blocks.dacite, Blocks.space},
            {Blocks.magmarock, Blocks.hotrock, Blocks.sand, Blocks.dirt, Blocks.darkPanel5, Blocks.moss, Blocks.basalt,
                Blocks.hotrock, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.space},
            {Blocks.hotrock, Blocks.water, Blocks.sand, Blocks.sand, Blocks.darksand, Blocks.darksand, Blocks.sporeMoss,
                Blocks.darkPanel6, Blocks.basalt, Blocks.ice, Blocks.metalFloor5, Blocks.ice, Blocks.ice, Blocks.space},
            {Blocks.metalFloor5, Blocks.darksandWater, Blocks.darksand, Blocks.dirt, Blocks.snow, Blocks.moss,
                Blocks.snow, Blocks.snow, Blocks.metalFloor, Blocks.snow, Blocks.ice, Blocks.metalFloor5, Blocks.ice,
                Blocks.space},
            {Blocks.taintedWater, Blocks.darksandTaintedWater, Blocks.snow, Blocks.ice, Blocks.iceSnow, Blocks.ice,
                Blocks.sporeMoss, Blocks.snow, Blocks.metalFloor3, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice,
                Blocks.space},
            {Blocks.darksandTaintedWater, Blocks.darksand, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.iceSnow,
                Blocks.sporeMoss, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
            {Blocks.darksandWater, Blocks.darksand, Blocks.snow, Blocks.ice, Blocks.iceSnow, Blocks.snow,
                Blocks.darkPanel4, Blocks.snow, Blocks.ice, Blocks.metalFloor5, Blocks.ice, Blocks.ice, Blocks.ice},
        };
    ...
    public WrekPlanetGenerator() {
        // defaultLoadout = new Schematic(Seq.with(new Schematic.Stile(DsBlocks.dimensionTechnologyCore5, 0, 0, null,
        // (byte)0)), new StringMap(), 5, 5);
    ...
    public void genTile(Vec3 position, TileGen tile) {
        ...
        if (Ridged.noise3d(seed + 1, position.x, position.y, position.z, 2, 22) > 0.32) {
    ...
    Block getBlock(Vec3 position) {
        ...
        Block res = arr[Mathf.clamp((int) (temp * arr.length), 0, arr[0].length - 1)][Mathf.clamp(
            (int) (height * arr[0].length), 0, arr[0].length - 1)];
        if (tar > 0.5f) {
    ...
    protected void generate() {
        ...
        class Room {
            ...
            void connect(Room to) {
                ...
                if (alt) {
                    midpoint.add(
                        Tmp.v2.set(1, 0f).setAngle(Angles.angle(to.x, to.y, x, y) + 90f * (rand.chance(0.5) ? 1f : -1f))
        ...
        for (int i = 0; i < 360; i += angleStep) {
            ...
            if (waterTiles <= 4 || (i + angleStep >= 360)) {
                roomseq.add(spawn = new Room(cx, cy, rand.random(16, 32)));

                float previous = -85;
                float angleStep2 = 12;
                for (int j = 0; j < enemySpawns; j++) {
                    float enemyOffset = previous + angleStep2 + rand.random(12);
                    previous = enemyOffset;
                    Tmp.v1.set(cx - width / 2, cy - height / 2).rotate(180f + enemyOffset).add(width / 2, height / 2);
                    Room espawn = new Room((int) Tmp.v1.x, (int) Tmp.v1.y, rand.random(16, 32));
                    roomseq.add(espawn);
                    enemies.add(espawn);
                }
        ...
        for (int i = 0; i < connections; i++) {
            ...
            int ran1 = rand.random(0, roomseq.size - 1);
            int ran2 = rand.random(0, roomseq.size - 1);
            var r1 = roomseq.get(ran1);
            var r2 = roomseq.get(ran2);
            r1.connect(r2);
        }
        ...
        if (Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x, sector.tile.v.y, sector.tile.v.z) * nmag + poles >
            0.25f * addscl) {
            ores.add(Blocks.oreCoal);
        }

        if (Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x + 1, sector.tile.v.y, sector.tile.v.z) * nmag + poles >
            0.5f * addscl) {
            ores.add(Blocks.oreTitanium);
        }

        if (Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x + 2, sector.tile.v.y, sector.tile.v.z) * nmag + poles >
            0.65f * addscl) {
        ...
        pass((x, y) -> {
            ...
            // Walls to space
            if (this.block != Blocks.air && Math.abs(0.5 - noise(x, y, 4, 0.7, 50)) < 0.11 &&
                !roomseq.contains(r -> Mathf.within(x, y, r.x, r.y, 25))) {
            ...
            if (floor == Blocks.darksand) {
                if (Math.abs(0.5f - noise(x - 40, y, 2, 0.7, 80)) > 0.25f &&
                    ...
                    !(roomseq.contains(r -> Mathf.within(x, y, r.x, r.y, 15)))) {
                    floor = Blocks.tar;
                    this.ore = Blocks.air;
                }
            }

            final ObjectSet<Block> metalFloor = ObjectSet.with(
                Blocks.darkPanel1,
                Blocks.darkPanel2,
                Blocks.darkPanel3,
                Blocks.darkPanel4,
            ...
            final ProbabilitySelector<Block> randomBlock = new ProbabilitySelector<>(20);
            randomBlock.add(Blocks.space, 600);
            randomBlock.add(Blocks.basalt, 100);
            randomBlock.add(Blocks.charr, 100);
            randomBlock.add(Blocks.craters, 100);
            randomBlock.add(Blocks.dacite, 100);
            randomBlock.add(Blocks.darkPanel1, 8);
            randomBlock.add(Blocks.darkPanel2, 8);
            randomBlock.add(Blocks.darkPanel3, 8);
            randomBlock.add(Blocks.darkPanel4, 8);
            randomBlock.add(Blocks.darkPanel5, 8);
            randomBlock.add(Blocks.darkPanel6, 8);
            randomBlock.add(Blocks.darksand, 100);
            randomBlock.add(Blocks.darksandTaintedWater, 100);
            randomBlock.add(Blocks.darksandWater, 100);
            randomBlock.add(Blocks.dirt, 100);
            randomBlock.add(Blocks.grass, 100);
            randomBlock.add(Blocks.hotrock, 100);
            randomBlock.add(Blocks.ice, 100);
            randomBlock.add(Blocks.iceSnow, 100);
            randomBlock.add(Blocks.magmarock, 100);
            randomBlock.add(Blocks.metalFloor, 8);
            randomBlock.add(Blocks.metalFloor2, 8);
            randomBlock.add(Blocks.metalFloor3, 8);
            randomBlock.add(Blocks.metalFloor5, 8);
            randomBlock.add(Blocks.metalFloorDamaged, 15);
            randomBlock.add(Blocks.moss, 100);
            randomBlock.add(Blocks.mud, 100);
            randomBlock.add(Blocks.sand, 100);
            randomBlock.add(Blocks.sandWater, 100);
            randomBlock.add(Blocks.snow, 100);
            randomBlock.add(Blocks.sporeMoss, 100);
            randomBlock.add(Blocks.stone, 100);
            randomBlock.add(Blocks.water, 100);


            // space corruption
            if (this.block == Blocks.air && this.floor != Blocks.space) {
                if (metalFloor.contains(this.floor)) {
                    if (Math.abs(0.5 - noise(x, y, 4, 0.7, 50)) > 0.20 &&
                        !(roomseq.contains(r -> Mathf.within(x, y, r.x, r.y, 25)))) {
                        this.floor = randomBlock.random();
                        this.ore = this.floor != Blocks.space && rand.chance(0.25) ? dimensionShardOre : Blocks.air;
                    }
                } else {
                    if (Math.abs(0.5 - noise(x, y, 4, 0.6, 60)) > 0.24 &&
                        !(roomseq.contains(r -> Mathf.within(x, y, r.x, r.y, 25)))) {
                        this.floor = randomBlock.random();
                        this.ore = this.floor != Blocks.space && rand.chance(0.25) ? dimensionShardOre : Blocks.air;
                    }
        ...
        if (ruinCount > 0) {
            ...
            for (int i = 0; i < ints.size && placed < ruinCount; i++) {
                ...
                if (part != null && WrekBaseGenerator.tryPlace(part, x, y, Team.derelict, (cx, cy) -> {
        ...
        state.rules.waveSpacing =
            Mathf.lerp(60 * 65 * 2, 60f * 60f * 1f, Math.max(difficulty - waveTimeDec, 0f) / 0.8f);
        ...
        state.rules.spawns = WrekWaveGenerator.generate(difficulty, new Rand(sector.id), state.rules.attackMode,
    ...
    public void postGenerate(Tiles tiles) {
        if (sector.hasEnemyBase()) {
            ...
            if (spawner.countGroundSpawns() == 0) {
                state.rules.spawns =
                    WrekWaveGenerator.generate(sector.threat, new Rand(sector.id), state.rules.attackMode, true, false);
            }
        }
    }
}
